...
<html lang="en">
  ...
  <body>
    ...
    <script > const insert = document.getElementById('insert');
...
function startprinting() {
    if (!intervalId) {
        console.log('start')
      intervalId = setInterval(saydate, 2000,'Amonji');
    }
  }
...
function stopfnx() {
  ...
  document.querySelector('#start').addEventListener('click', startprinting);
document.querySelector('#stop').addEventListener('click', stopfnx);
